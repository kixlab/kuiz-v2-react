					...
					<main>
						<Routes>
							{cType && (
								<Route
									path="/:cid"
									element={<QuestionListOption  classType={cType} />}
								/>
							)}
							<Route
								path="/:cid/qlist"
								element={<QuestionList classType={cType}/>}
							/>
							<Route
								path="/kakaologin"
								element={<Kakao classType={cType}/>}
							/>
							<Route
								path="/:cid/question/:id"
								element={<Question classType={cType}/>}
							/>
							<Route
								path="/:cid/createstem"
								element={
									cType ? (
										<StemCreate classType={cType}/>
									) : (
										<StemCreate2 classType={cType}/>
									)
								}
							/>
							{cType && (
							...
							<Route
								path="/:cid/mypage"
								element={<MyPage classType={cType}/>}
							/>
							{isAdmin && (
								<Route
									path="/:cid/admin"
									element={<Admin  classType={cType}/>}
								/>
							)}
